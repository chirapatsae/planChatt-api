// ===================================================================
// EditBookDisplayStateDto — Wave A2 / BE-01 (OPTION-A-FULL-SPLIT)
// ===================================================================
//
// Display-state envelope returned by
// `GET /v1/edit-assembly/:developmentPlanRevisionId/book-state`.
//
// Shape kept parity with `MainBookDisplayStateDto` /
// `SupplementBookDisplayStateDto` and the edit-revision branch of the
...
export enum EditBookDisplayStateEnum {
  NO_BOOK = 'no_book',
  DRAFT = 'draft',
...
export class EditBookDisplayStateDto {
  ...
  state: EditBookDisplayStateEnum;

  /**
   * Wave A2 / BE-01 — hard-coded false. The cross-revision
  ...
  /**
   * Wave A2 / BE-01 — hard-coded 0. Per-RPG "blocked" counting was
   * meaningful only against the legacy unified lineage table.
   * `edit_project_lineage` enforces "at most one leaf per RPG" at the

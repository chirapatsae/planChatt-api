// ===================================================================
// EditReadinessDto — Wave A2 / BE-01 (OPTION-A-FULL-SPLIT)
// ===================================================================
//
// Readiness envelope returned by
// `GET /v1/edit-assembly/:developmentPlanRevisionId/readiness`.
//
// Shape kept byte-for-byte parity with `MainReadinessDto` /
// `RevisionReadinessDto` / `SupplementReadinessDto` so the shared FE
// `BookAssemblyDashboard` / `DraftPanel` components can consume it
// without an adapter fork. Q3=B isolation — duplicated, not shared.
//
...
export class EditReadinessBreakdownDto {
...
export class EditReadinessDto {
  ...
  breakdown: EditReadinessBreakdownDto;
}

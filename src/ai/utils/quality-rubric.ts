...
export const QUALITY_RUBRIC: readonly RubricEntry[] = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      'งบประมาณรวมต้องสมเหตุสมผลกับขอบเขตของเป้าหมาย (จำนวนผู้รับประโยชน์ / พื้นที่ / จำนวนกิจกรรม)',
      'กระจายงบประมาณสอดคล้องกับระยะเวลาดำเนินโครงการ',
    ],
    mustAvoid: [
      'ขอบเขตคลุมเครือที่ทำให้กรอกงบประมาณค่าใดก็ดูสมเหตุสมผล',
      'ห้ามแนะนำให้ "ระบุการจัดสรรรายปี" หรือ "แบ่งงบตามปี" เพราะระบบเก็บข้อมูลงบประมาณเป็นรายปีอยู่แล้ว (budgets: { year, quantity }[])',
      'ห้ามแนะนำให้ "แจกแจงงบประมาณรายกิจกรรม" หรือ "แสดงรายละเอียดการใช้จ่ายรายกิจกรรม" เพราะระบบไม่รองรับการเก็บข้อมูลงบประมาณระดับกิจกรรม',
    ],
    goodExample:
      '2,500,000 บาท กระจายตลอด 2 ปี สอดคล้องกับขอบเขต 200 ครัวเรือน ต้นทุนต่อรายประมาณ 12,500 บาท',
    badExample:
      'แนะนำว่าควรแจกแจงงบประมาณรายกิจกรรม / ควรระบุการจัดสรรรายปีให้ชัดเจน',
  },
];

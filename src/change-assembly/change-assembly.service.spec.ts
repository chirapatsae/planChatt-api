...
async function buildService(opts: BuildOpts = {}): Promise<{
  ...
  // undefined; getReadiness tests assert the RPG counts via a separate mock.
...
// ===================================================================
//
// CHANGE shares EDIT's RELPG discriminator ('revised_equipment') and the
// identical resetRelpgBooking helper. Coverage mirrors the EDIT spec:
...
describe('ChangeAssemblyService RELPG booking un-stamp (cancel / CORRECTION_PART3)', () => {
